...
*/
  	...
  	public function check(){
  		...
  		if ($this->cart->hasShipping()) {
	  		if($this->customer->getAddressId()!=0 || (isset($this->session->data['shipping_address_id']) && $this->session->data['shipping_address_id']!=0)){
	  			$json['error'] = false;
	  		}else{
	  			$json['error'] = true;
	  			$json['error_msg'] = $this->language->get('error_address');
	  		}
  		}else{
  			$json['error'] = true;
  		}

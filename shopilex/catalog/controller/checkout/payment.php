	...
	public function index() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			if (isset($this->session->data['payment_method']['code'])) {
				...
				$this->customer->setPaymentMethod($this->data['code']);
			} else {
				$this->data['code'] =  $this->customer->getPaymentMethod();
			}
			...
			if(isset($this->request->get['action'])&&$this->request->get['action']=='modifypm'){
				if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/payment_modified.tpl')) {
					$this->template = $this->config->get('config_template') . '/template/checkout/payment_modified.tpl';
				} else {
					$this->template = 'default/template/checkout/payment_modified.tpl';
				}
			}else{

...
class ControllerSettingStore extends Controller {
	...
	public function getForm() { 
		...
		if (isset($this->request->post['config_active'])) {
			$this->data['config_active'] = $this->request->post['config_active'];
		} elseif (isset($store_info['config_active'])) {
			$this->data['config_active'] = $store_info['config_active'];		
		} else {
			$this->data['config_active'] = '';
		}

...
class ControllerAccountOrder extends Controller {
	...
	public function info() { 
		...
		/*	$this->data['shipping_address']=$order_info['shipping_firstname']."\n".$order_info['shipping_zone'].$order_info['shipping_city'].$order_info['shipping_address_1']
			. $order_info['shipping_address_2']."\n".$order_info['shipping_postcode']."\n".$order_info['shipping_mobile']."\n".$order_info['shipping_phone'];*/

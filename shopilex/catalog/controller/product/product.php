...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			$this->data['tab_related_images'] = $this->language->get('tab_related_images');
	...
	public function write() {
		...
		if ((strlen(utf8_decode($this->request->post['text'])) < 10) || (strlen(utf8_decode($this->request->post['text'])) > 1000)) {
